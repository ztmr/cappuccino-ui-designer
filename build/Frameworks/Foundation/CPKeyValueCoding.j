...
{
    throw new Error([self _objectDescription] + " is not key value coding-compliant for the key " + aKey);
...
{
    return "<" + [self className] + " 0x" + [self UID] + ">";
}
...
@implementation CPString (CPKeyValueCoding)
